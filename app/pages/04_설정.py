...
/* OFF 상태 */
div.st-key-toggle1 label[data-baseweb="checkbox"] > div {
    background-color:  #E7E1FF !important; /* 회색 */
}

/* ON 상태 (st-dr 포함 시) */
div.st-key-toggle1 label[data-baseweb="checkbox"] > div.st-dr {
    background-color: #BFA9F2 !important; /* 보라 */
}
/* OFF 상태 */
div.st-key-toggle2 label[data-baseweb="checkbox"] > div {
    background-color: #D6F3E7 !important; /* 회색 */
}

/* ON 상태 */
div.st-key-toggle2 label[data-baseweb="checkbox"] > div.st-dr {
    background-color: #8FDAC8 !important; /* 민트 */
}
...
div[data-testid="stSelectbox"] > div {
    background-color: #E7E1FF !important;  /* 옅은 보라 */
...
div[data-testid="stSelectbox"] > div > div {
    background-color: #E7E1FF !important;  /* 선택 영역 배경 */
...
/* Selectbox 빨간 포커스 / 경고 테두리 제거 */
div[data-testid="stSelectbox"] button,
div[data-testid="stSelectbox"] button:focus,
div[data-testid="stSelectbox"] button:focus-visible,
div[data-testid="stSelectbox"] button:focus-within,
div[data-testid="stSelectbox"] div:focus,
div[data-testid="stSelectbox"] div:focus-visible,
div[data-testid="stSelectbox"] div:focus-within {
    outline: none !important;
    box-shadow: none !important;
    border-color: #E7E1FF  !important; /* 우리가 지정한 보라색 유지 */
}
</style>""",
...
st.markdown(
    "<p style='font-size:35px; font-weight:600;'>Settings</p>", unsafe_allow_html=True
)
st.markdown(
...
with st.container():
    ...
    with colC:
        st.markdown('<div class="toggle-1"></div>', unsafe_allow_html=True)
...
with st.container():
    ...
    with colC:
        st.markdown('<div class="toggle-2"></div>', unsafe_allow_html=True)
...
districts = ["감만동", "대연동", "문현동", "용당동", "용호동", "우암동"]
...
st.markdown(
    f"""
<div class="setting-card" style="display:flex; align-items:center; margin-top:25px;">
    <div style="flex:2.5;">
